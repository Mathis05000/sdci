...
var LOCAL_ENDPOINT = {IP : argv.local_ip, PORT : argv.local_port, NAME : process.env.DEVICE_NAME};
var REMOTE_ENDPOINT = {IP : argv.remote_ip, PORT : argv.remote_port, NAME : process.env.GW_NAME};
